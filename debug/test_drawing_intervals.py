...
def test_interval_enforcement():
    ...
    will_draw = drawing_controller.should_draw(mood=0.8, novelty=0.9, boredom=0.9)  # Very high motivation
    ...
    will_draw = drawing_controller.should_draw(mood=0.1, novelty=0.1, boredom=0.1)  # Very low motivation
    ...
    will_draw = drawing_controller.should_draw(mood=-0.8, novelty=0.0, boredom=0.0)  # Very low motivation
