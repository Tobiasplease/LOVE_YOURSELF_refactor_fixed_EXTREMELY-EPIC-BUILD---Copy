...
try:
    while True:
        ...
        if ret and frame is not None:
            ...
            display = frame.copy()
            cv2.putText(display, f"Pan: {pan}  Tilt: {tilt}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            cv2.putText(display, "A/D=pan W/S=tilt Q=save ESC=quit", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
