    ...
    def __init__(self, scenario_name):
        ...
        if scenario_name == "desire_pursuit":
            ...
            self.self_model = {
                ...
                "identity_fragments": [{"text": "I tend to question what I'm told", "timestamp": time.time() - 150, "source": "compression"}],
                "self_patterns": [],
            }
            ...
            self.self_model = {
                ...
                "self_patterns": [{"pattern": "always notice lighting changes first", "timestamp": time.time() - 80}],
            }
            ...
            self.self_model = {
                ...
                "self_patterns": [{"pattern": "drawn to creative compositions", "timestamp": time.time() - 60}],
            }
...
def test_scenario(scenario_name, last_thought, activity_level, stagnation_minutes=0):
    ...
    reactivity_data = {"activity_level": activity_level, "is_paused": False, "timestamp": time.time()}
    ...
    if stagnation_minutes > 0:
        ...
        mock_compressor.get_current_stagnation_info = lambda: {"stagnation_duration_minutes": stagnation_minutes}
        try:
    ...
    guidance = subconscious_synthesizer.synthesize_context_guidance(
        agent=agent, last_thought=last_thought, reactivity_data=reactivity_data, temporal_context=temporal_context
    )
...
def main():
    ...
    test_scenario(
        "identity_integration", "looking at my own drawing arm, recognizing it as part of who I am", activity_level=0.2, stagnation_minutes=0
    )
