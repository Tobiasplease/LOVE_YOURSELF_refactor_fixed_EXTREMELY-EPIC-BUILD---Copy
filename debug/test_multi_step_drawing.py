...
def test_multi_step_drawing():
    ...
    if hasattr(captioner, 'beliefs'):
        captioner.beliefs = {
            'lighting_patterns': 0.8,
            'workspace_activity': 0.6,
            'shadow_relationships': 0.9
        }
    ...
    try:
        ...
        drawing_prompt = captioner.model.generate_drawing_prompt(
            extra="Testing multi-step analysis with accumulated consciousness context",
        ...
        context_indicators = [
            "accumulated", "identity", "consciousness", "beliefs",
            "drawing history", "emotional", "communication", "technique"
        ]
