...
check("2h still → the stretch line (Sep 13)", get_unchanged_line(a).startswith("It's been a long time now since anything happened. In that time you've looked away once"), get_unchanged_line(a))
