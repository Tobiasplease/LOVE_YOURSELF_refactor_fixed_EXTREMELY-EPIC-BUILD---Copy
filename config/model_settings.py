...
MODEL_GENERATION_OPTIONS = {
    ...
    "qwen2.5vl:3b": {
        ...
        "stop": [
            ...
            "the drawing machine",
            "I see the drawing machine",
            "the machine",
            "drawing machine consciousness",
            "I observe the",
            "watching the",
        ],
    },
...
MODEL_PROMPT_STYLES = {"llava:7b-v1.6-mistral-q5_1": "rich_detailed", "qwen2.5vl:3b": "scene_beats", "qwen2.5vl:7b": "scene_beats"}
