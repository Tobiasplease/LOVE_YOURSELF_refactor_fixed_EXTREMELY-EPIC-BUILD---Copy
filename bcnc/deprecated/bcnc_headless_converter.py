...
# import sys
# import os
from bcnc_utils import check_bcnc_available
...
def try_bcnc_internal():
    ...
    try:
        ...
        import_attempts = ["bCNC.CNC", "bCNC.Block", "bCNC.SVG", "CNC", "Block"]
...
def main():
    ...
    approaches = [("Interna moduler", try_bcnc_internal), ("Script-läge", try_bcnc_script_mode), ("Python modul", try_python_bcnc)]
