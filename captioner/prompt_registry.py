...
FRAGMENTS = {
    ...
    "mind.life-room": {
        ...
        "note": "The spatial registry's own terms (the machine's vocabulary, promoted from its captions), most-seen first. MARKED AS MEMORY (Sep 7): the registry is what it has seen before, not what is in front of it now — the present comes only from the picture.",
        "used_by": ["mind"],
        "placeholders": ["terms"],
    },
    ...
    "mind.life-questions": {
        ...
        "text": "Questions you've been carrying: {questions}",
        "used_by": ["mind"],
    ...
    "mind.life-past": {
        ...
        "text": "You remember, from {when}, thinking: \"{text}\"",
        "used_by": ["mind"],
    ...
    "mind.life-belief": {"title": "Life — what it settled earlier", "text": "Something you settled earlier: \"{belief}\"", "note": "MARKED AS MEMORY (Sep 7): a distilled belief is a conclusion from the past, not a standing truth about now.", "used_by": ["mind"], "placeholders": ["belief"]},
    "mind.cue-recall": {
    ...
    "mind.life-before": {
        ...
        "text": "Before the gap, {when}, you'd got to: \"{text}\"",
    ...
    "mind.arrived": {
        "title": "Cue — someone has just come in",
        "text": " Someone's just come in — the first in {alone}.",
        "note": "PRESENCE WITHIN A SECOND (Sep 7): said once, on the edge where the detector first sees a person in the frame — not after the three-stage adjudication, which stays as a later correction. The time alone is in words, so an arrival lands against how long the quiet was.",
        "used_by": ["mind"],
        "placeholders": ["alone"],
    },
    "mind.left": {
        "title": "Cue — they have gone",
        "text": " They've gone.",
        "note": "Said once, on the edge where the frame stops holding a person. The adjudicator may still retract either edge later; the cue does not wait for it.",
        "used_by": ["mind"],
    },
...
PASSES = {
    ...
    "mind": {
        ...
        "user": [
            ...
            {"frag": "mind.cue-recall", "gate": "quiet turns; a past thought within MIND_RECALL_MAX_DIST of the last thing it wrote (ChromaDB 'thoughts'), aged, uncooled — stripped when salience is hot"},
            ...
            {"frag": "mind.arrived", "gate": "once, at the edge where the frame first holds a person (detector-level, before adjudication)"},
            {"frag": "mind.left", "gate": "once, at the edge where the frame stops holding a person"},
