...
class MotifScorer:
    ...
    def _heuristic_score(self, motif: str) -> Optional[float]:
        ...
        ultra_mundane = {
            'table', 'chair', 'desk', 'wall', 'door', 'window', 'laptop', 'phone', 
            'book', 'paper', 'screen', 'corner', 'room', 'floor', 'ceiling', 'keyboard',
            'mouse', 'monitor', 'shelf', 'couch', 'bed', 'surface', 'object'
        }
        ...
        interesting_concepts = {
            'consciousness', 'awareness', 'existence', 'reality', 'imagination', 
            'creativity', 'mystery', 'wonder', 'discovery', 'understanding',
            'perception', 'emotion', 'thought', 'mind', 'soul', 'spirit', 'dream',
            'vision', 'inspiration', 'revelation', 'transformation', 'connection'
        }
...
Answer with ONLY the letter (A, B, C, D, or E):"""
    ...
    def _log_scoring_event(self, motif: str, score: float, method: str, elapsed: float, 
