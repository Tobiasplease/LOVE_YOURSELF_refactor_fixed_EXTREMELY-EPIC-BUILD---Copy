...
from config.config import TINYLLAMA_TEMPERATURE, TINYLLAMA_TOP_P, TINYLLAMA_NUM_PREDICT, TINYLLAMA_TIMEOUT
...
Example: creative energy, quiet contemplation, digital focus"""
    ...
    def _query_tinyllama_themes(self, prompt: str) -> List[str]:
        ...
        response = requests.post(
            ...
            json=payload,
            timeout=60.0  # Generous timeout for meaningful analysis
        )
