...
MEANINGFUL_MOTIFS = {
    "desk", "keyboard", "screen", "monitor", "computer", "laptop", "workspace", "chair", "window", "light", "shadow",
    "books", "papers", "coffee", "mug", "plant", "headphones", "mouse", "phone", "tablet", "notebook", "pen",
    "wall", "door", "ceiling", "floor", "shelf", "bottle", "glass", "clock", "lamp", "cable", "cord",
    "hand", "face", "person", "eye", "hair", "shirt", "clothing", "skin",
    "movement", "typing", "writing", "reading", "sitting", "standing", "walking", "looking", "thinking",
    "focus", "concentration", "attention", "awareness", "presence", "calm", "energy", "stillness"
}

MOTIF_BLACKLIST = {
    "the", "and", "or", "but", "in", "on", "at", "to", "for", "of", "with", "by", "from", "up", "about", "into", "through",
    "during", "before", "after", "above", "below", "between", "among", "this", "that", "these", "those", "i", "you", "he",
    "she", "it", "we", "they", "me", "him", "her", "us", "them", "my", "your", "his", "her", "its", "our", "their",
    "what", "when", "where", "why", "how", "which", "who", "whom", "whose", "there", "here", "now", "then", "today",
    "yesterday", "tomorrow", "always", "never", "sometimes", "often", "usually", "rarely", "hardly", "almost", "quite",
    "very", "really", "pretty", "rather", "somewhat", "fairly", "extremely", "incredibly", "absolutely", "completely",
    "totally", "entirely", "perfectly", "exactly", "precisely", "generally", "basically", "essentially", "particularly",
    "especially", "specifically", "probably", "possibly", "maybe", "perhaps", "definitely", "certainly", "surely",
    "obviously", "clearly", "apparently", "seemingly", "supposedly", "allegedly", "actually", "really", "truly",
    "indeed", "however", "moreover", "furthermore", "therefore", "thus", "hence", "consequently", "meanwhile",
    "otherwise", "nevertheless", "nonetheless", "besides", "instead", "rather", "alternatively", "similarly",
    "likewise", "accordingly", "subsequently", "previously", "currently", "recently", "lately", "soon", "eventually",
    "finally", "initially", "originally", "basically", "mainly", "mostly", "largely", "primarily", "chiefly",
    "particularly", "especially", "specifically", "notably", "remarkably", "surprisingly", "interestingly",
    "fortunately", "unfortunately", "hopefully", "thankfully", "regrettably", "sadly", "happily", "luckily"
}
...
class PatternRecognitionEngine:
    ...
    def _is_significant_motif(self, motif: str) -> bool:
        ...
        if (len(motif) > 4 and 
            not motif.endswith(("ing", "ed", "ly", "ness", "tion", "sion", "ment", "ful", "less"))):
            return True
    ...
    def _log_motif_temporality(self, timestamp: float, new_motifs: Set[str], 
                             recurring_motifs: Set[str], novelty: float):
